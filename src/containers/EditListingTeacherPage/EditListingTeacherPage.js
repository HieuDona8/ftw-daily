...
import { EditListingTeacherWizard, NamedRedirect, Page } from '../../components';
...
import {
  ...
  clearUpdatedTab,
  savePayoutDetails,
} from './EditListingTeacherPage.duck';

import css from './EditListingTeacherPage.module.css';
...
export const EditListingTeacherPageComponent = props => {
  const {
    currentUser,
...
EditListingTeacherPageComponent.defaultProps = {
...
EditListingTeacherPageComponent.propTypes = {
...
const EditListingTeacherPage = compose(
  withRouter,
  connect(
    mapStateToProps,
    mapDispatchToProps
  )
)(injectIntl(EditListingTeacherPageComponent));

export default EditListingTeacherPage;
