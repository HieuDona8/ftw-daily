...
import EditListingTeacherWizardTab, {
  GENERAL,
  LOCATION,
  PRICING,
  AVAILABILITY,
} from './EditListingTeacherWizardTab';
...
const tabLabel = (intl, tab) => {
  let key = null;
  if (tab === GENERAL) {
    key = 'EditListingTeacherWizard.tabLabelGeneral';
  } else if (tab === LOCATION) {
    key = 'EditListingTeacherWizard.tabLabelLocation';
  } else if (tab === PRICING) {
    key = 'EditListingTeacherWizard.tabLabelPricing';
  } else if (tab === AVAILABILITY) {
    key = 'EditListingTeacherWizard.tabLabelAvailability';
  }
...
class EditListingWizard extends Component {
  ...
  render() {
    ...
    if (!tabsStatus[selectedTab]) {
      ...
      return <NamedRedirect name="EditListingTeacherPage" params={{ ...params, tab: nearestActiveTab }} />;
    }
